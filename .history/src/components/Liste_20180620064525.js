  ...
  render() {
    ...
    return (
      <div className={classes.root}>
        <button onClick={() => this.toggleActive()}>Toggle List</button>

        <List>
          <VelocityTransitionGroup
            enter={{
              animation: "transition.slideLeftIn", // velocity-animate
              stagger: "200",
              duration: "400"
            }}
            ...
            {tileData.map(tile => (
              <ListItem>
                ...
                <Typography variant="caption">
                  ...
                  rappe ou un zesteur, récupérer le zeste du citron, à ajouter à
                  la pâte. Etape 3 Presser le citron et verser le jus dans le
                  mélange. Si possible, ajouter la pulpe (mais pas les pépins
                  !). Etape 4 Mélanger jusqu'à obtention d'une pâte onctueuse et
                  homogène. Etape 5 Beurrer un plat à gateau et y verser la
                  pâte. Etape 6 Cuire au four pendant 25 min environ à 200°C
                  (thermostat 6-7).
                </Typography>
              </ListItem>
            ))}
